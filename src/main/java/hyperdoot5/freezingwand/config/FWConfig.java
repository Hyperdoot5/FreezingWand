...
//
//    // -- Dimension --
//    public static boolean newPlayersSpawnInFW = false;
...
////                FreezingWandMod.DEBUG.fatal("The portal locking advancement is not a valid advancement! Setting to null!");
...
////                FreezingWandMod.DEBUG.debug("Portal locking advancement reloaded. Current advancement to check for is: {}", portalLockingAdvancement);
////            }
////        }
...
//                    FreezingWandMod.DEBUG.warn("Biome {} in Twilight Forest's validAuroraBiomes config option is not a valid biome. Skipping!", s);
//                } else {
...
//    }
//
//    protected static void rebakeCommonOptions(FWCommonConfig config) {
...
//
//        //Dimension
//        newPlayersSpawnInFW = config.DIMENSION.newPlayersSpawnInFW.get();
...
//    }
//
//    protected static void rebakeClientOptions(FWClientConfig config) {
...
//    }
//
//    private static void reloadGiantSkins(FWClientConfig config) {
...
//                            FreezingWandMod.DEBUG.error("\"{}\" is not a valid UUID!", stringUUID);
//                        }
//                    }
//                    super.run();
//                }
