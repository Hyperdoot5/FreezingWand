...
//
//    public FWClientConfig(ModConfigSpec.Builder builder) {
//        silentCicadas = builder
//                .translation(FWConfig.CONFIG_ID + "silent_cicadas")
...
//                .translation(FWConfig.CONFIG_ID + "silent_cicadas_on_head")
...
//                .translation(FWConfig.CONFIG_ID + "first_person_effects")
...
//                .translation(FWConfig.CONFIG_ID + "animate_trophies")
...
//                .translation(FWConfig.CONFIG_ID + "optifine")
...
//                .translation(FWConfig.CONFIG_ID + "locked_toasts")
...
//                .translation(FWConfig.CONFIG_ID + "ram_indicator")
...
//                .translation(FWConfig.CONFIG_ID + "shield_indicator")
...
//                .translation(FWConfig.CONFIG_ID + "shield_indicator_creative")
...
//                .translation(FWConfig.CONFIG_ID + "cloud_block_precipitation_distance")
//                .comment("""
...
//                .translation(FWConfig.CONFIG_ID + "giant_skin_uuid_list")
//                .comment("""
...
//                .translation(FWConfig.CONFIG_ID + "aurora_biomes")
//                .comment("Defines which biomes the aurora shader effect will appear in. Leave the list empty to disable the effect.")
//                .defineListAllowEmpty("auroraBiomes", List.of("freezingwand:glacier"), s -> s instanceof String);
//
//        prettifyOreMeterGui = builder
//                .translation(FWConfig.CONFIG_ID + "prettify_ore_meter_gui")
//                .comment("Lines up dashes & percentages in Ore Meter GUI")
//                .define("prettifyOreMeterGui", true);
//
//        spawnCharmAnimationAsTotem = builder.translation(FWConfig.CONFIG_ID + "totem_charm_animation")
