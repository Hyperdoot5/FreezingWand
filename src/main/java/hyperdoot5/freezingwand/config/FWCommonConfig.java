...
//    final ModConfigSpec.EnumValue<FWConfig.MultiplayerFightAdjuster> multiplayerFightAdjuster;
//
//    public FWCommonConfig(ModConfigSpec.Builder builder) {
//        builder.comment("Settings that are not reversible without consequences.").push("Dimension Settings");
//        {
//            DIMENSION.newPlayersSpawnInFW = builder
//                    .translation(FWConfig.CONFIG_ID + "spawn_in_tf")
//                    .comment("If true, players spawning for the first time will spawn in the Twilight Forest.")
//                    .define("newPlayersSpawnInFW", false);
//            DIMENSION.portalForNewPlayerSpawn = builder
//                    .translation(FWConfig.CONFIG_ID + "portal_for_new_player")
//                    .comment("If true, the return portal will spawn for new players that were sent to the FW if `spawn_in_tf` is true.")
...
//                    .translation(FWConfig.CONFIG_ID + "origin_dimension")
...
//                    .translation(FWConfig.CONFIG_ID + "portals_in_other_dimensions")
...
//                    .translation(FWConfig.CONFIG_ID + "portal_permission")
//                    .comment("""
...
//                    .translation(FWConfig.CONFIG_ID + "portals")
...
//                    .translation(FWConfig.CONFIG_ID + "check_portal_placement")
//                    .comment("""
...
//                    .translation(FWConfig.CONFIG_ID + "destructive_portal_lighting")
...
//                    .translation(FWConfig.CONFIG_ID + "portal_return")
...
//                    .translation(FWConfig.CONFIG_ID + "portal_unlocked_by_advancement")
...
//                    .translation(FWConfig.CONFIG_ID + "max_portal_size")
...
//                .worldRestart()
//                .translation(FWConfig.CONFIG_ID + "casket_uuid_locking")
//                .comment("""
...
//                .translation(FWConfig.CONFIG_ID + "disable_skull_candles")
...
//                .worldRestart()
//                .translation(FWConfig.CONFIG_ID + "default_item_enchantments")
//                .comment("""
...
//                .translation(FWConfig.CONFIG_ID + "boss_drop_chests")
//                .comment("""
...
//                .translation(FWConfig.CONFIG_ID + "cloud_block_precipitation_distance_server")
//                .comment("""
...
//                .worldRestart()
//                .translation(FWConfig.CONFIG_ID + "multiplayer_fight_adjuster")
//                .comment("""
...
//				MORE_LOOT: adds additional drops to a boss' loot table based on how many players participated in the fight. These are fully controlled through the entity's loot table, using the `freezingwand:multiplayer_multiplier` loot function. Note that this function will only do things to entities that are included in the `freezingwand:multiplayer_inclusive_entities` tag.
...
//                .defineEnum("multiplayerFightAdjuster", FWConfig.MultiplayerFightAdjuster.NONE);
//
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "uncrafting_xp_cost")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "repairing_xp_cost")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "uncrafting_recipes")
//                    .comment("""
...
//					Example: "freezingwand:firefly_particle_spawner" will disable uncrafting the particle spawner into a firefly jar, firefly, and poppy.
//					If an item has multiple crafting recipes and you wish to disable them all, add the item to the "freezingwand:banned_uncraftables" item tag.
//					If you have a problematic ingredient, like infested towerwood for example, add the item to the "freezingwand:banned_uncrafting_ingredients" item tag.""")
//                    .defineListAllowEmpty("disableUncraftingRecipes", List.of("freezingwand:giant_log_to_oak_planks"), s -> s instanceof String);
//            UNCRAFTING_STUFFS.reverseRecipeBlacklist = builder
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "uncrafting_recipes_flip")
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "uncrafting_mod_ids")
//                    .comment("""
...
//					Example: "freezingwand" will disable all uncrafting recipes from this mod.""")
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "uncrafting_mod_id_flip")
...
//                    .worldRestart().
//                    translation(FWConfig.CONFIG_ID + "shapeless_uncrafting")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "disable_ingredient_switching")
//                    .comment("""
...
//					If you want to prevent certain ingredients from showing up in the first place, use the "freezingwand:banned_uncrafting_ingredients" tag.""")
//                    .define("disableIngredientSwitching", false);
//            UNCRAFTING_STUFFS.disableUncraftingOnly = builder
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "disable_uncrafting")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "disable_uncrafting_table")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "time_range")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "transformation_range")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "mining_range")
//                    .comment("""
...
//                    .worldRestart()
//                    .translation(FWConfig.CONFIG_ID + "sorting_range")
//                    .comment("""
...
//                    .translation(FWConfig.CONFIG_ID + "parry_non_twilight")
...
//                    .translation(FWConfig.CONFIG_ID + "parry_window")
...
//        ModConfigSpec.BooleanValue newPlayersSpawnInFW;
...
//    }
//    /*can disable checkcunkutil
//     *   can change checkchunkutil size
//     * can choose anivl repair, crafting table repair, or both
//     *   can change anvil repair xpcost and material cost
//     *   can change crafting table repair amount (durability)
//     *   can change crafting table repair recipe (type of blocks)
//     * can disable wand functions like attunements, or what predefined items can or cant be placed on
//     * can disable wand slowness and freezing function
//     *
//     * extras:
//     * can directly choose if to have one wand or 4 with different purposes*/
//}
