...
import static hyperdoot5.freezingwand.init.FWItems.FREEZING_WAND;

public class FWCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FREEZING_WAND_TAB = CREATIVE_MODE_TABS.register("freezing_wand", () -> CreativeModeTab.builder()
